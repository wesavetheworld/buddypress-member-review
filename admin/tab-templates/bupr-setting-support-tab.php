            ...
            <div class="bupr-admin-row border">
                <div class="bupr-admin-col-12">
                       <button class="bupr-accordion"> 
                        ...
                        <div class="panel">
                            <p> 
                                <?php _e( 'Yes you can use the review form on other page, just copy shortcode from review setting page and paste it on the other page.', BUPR_TEXT_DOMAIN );?>
                            </p>
                        </div>
                </div>
            </div>
